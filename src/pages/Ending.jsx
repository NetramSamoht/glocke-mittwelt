  ...
  return (
    <article className={`ending ending--${ending.id.toLowerCase()}`}>
      <header className="ending__header">
        ...
        <div
          className={`ending__tag ending__tag--${honest ? "honest" : "lied"}`}
        >
      ...
      <div className="ending__choices">
        ...
        <ul>
          ...
          <li>
            Beim Wassermann:{" "}
            <strong>{choiceLabel(state.choices.wassermann)}</strong>
          </li>
          <li>
            Bei der Moosfrau:{" "}
            <strong>{choiceLabel(state.choices.moosfrau)}</strong>
          </li>
          <li>
            Bei der Schmiedin:{" "}
            <strong>{choiceLabel(state.choices.schmiedin)}</strong>
          </li>
        </ul>
      </div>
